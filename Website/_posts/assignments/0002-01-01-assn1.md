...
categories:
 - assignment
title: "Assignment 1:  A primer on Probability and Statistics (due on 02/04)"
due:
tags:
 - week-2
permalink: /assn1/
...
- Write down the expression for the conditional distribution of $$p(y_B\lvert\theta_B)$$ and the prior $$p(\theta_B)$$.
